...
#' @field sin boolean Whether the tracks are sinusoidal or triangular
#' @field fi numeric The initial frequency of the sweep
#' @field ff numeric The final frequency of the sweep
#' @field phaseShift numeric The phase shift of the sweep
#' @field t0_Frame numeric The frame associated with time=0 of the sweep
#' @field timePerFrame numeric The time per frame of the data in seconds
#' @field sweepDurtion numeric The time duration of the sweep in seconds
#' @field tAll numeric vector The vector of times associate with 'allFrames'
